...
function () {
  ...
  SellerService.prototype.getReportList = function (data) {
    ...
    return this.http.get(global.urlBase + "vehicle/allRerportMechanicalFile", {
      params: data,
      headers: (_a = this.authSrv.getToken()) === null || _a === void 0 ? void 0 : _a.headers
    });
  };
  ...
  SellerService = __decorate([core_1.Injectable({
    providedIn: 'root'
  })], SellerService);
