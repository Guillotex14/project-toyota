...
@Component({
  selector: 'app-how-muhc-vehicle',
  templateUrl: './how-muhc-vehicle.page.html',
  styleUrls: ['./how-muhc-vehicle.page.scss'],
})
export class HowMuhcVehiclePage implements OnInit, AfterViewInit {
