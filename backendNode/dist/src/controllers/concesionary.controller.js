...
const concesionaryController = {};
concesionaryController.all = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let list = yield Concesionaries_schema_1.default.aggregate([
        {
            $match: search,
        },
        {
...
exports.default = concesionaryController;
//# sourceMappingURL=concesionary.controller.js.map